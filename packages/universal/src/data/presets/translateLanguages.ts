...
type BuiltinPersistedLangCode<T extends string> = PersistedLangCode & {
  readonly __builtinLangCode: T;
};
...
type BuiltinLangCode<T> = T extends { readonly __builtinLangCode: infer Code extends string }
  ? Code
  : never;
type BuiltinTranslateLangCode = BuiltinLangCode<
  (typeof BUILTIN_LANGUAGE)[keyof typeof BUILTIN_LANGUAGE]['langCode']
>;
