...
export const TranslateHistoryQuerySchema = z
  .object({
    ...
    limit: z
      .int()
      .positive()
      .max(TRANSLATE_HISTORY_MAX_LIMIT)
      .default(TRANSLATE_HISTORY_DEFAULT_LIMIT),
    /**
...
export type TranslateHistoryQueryParams = z.input<typeof TranslateHistoryQuerySchema> &
