...
export const FeishuAgentChannelEntitySchema = createAgentChannelEntitySchema(
  'feishu',
  FeishuAgentChannelConfigSchema,
);
export const QQAgentChannelEntitySchema = createAgentChannelEntitySchema(
  'qq',
  QQAgentChannelConfigSchema,
);
export const WeChatAgentChannelEntitySchema = createAgentChannelEntitySchema(
  'wechat',
...
export const SlackAgentChannelEntitySchema = createAgentChannelEntitySchema(
  'slack',
...
export const FeishuCreateAgentChannelSchema = createAgentChannelMutationSchema(
  'feishu',
  FeishuAgentChannelConfigSchema,
);
export const QQCreateAgentChannelSchema = createAgentChannelMutationSchema(
  'qq',
  QQAgentChannelConfigSchema,
);
export const WeChatCreateAgentChannelSchema = createAgentChannelMutationSchema(
  'wechat',
  WeChatAgentChannelConfigSchema,
);
...
export const SlackCreateAgentChannelSchema = createAgentChannelMutationSchema(
  'slack',
  SlackAgentChannelConfigSchema,
);
