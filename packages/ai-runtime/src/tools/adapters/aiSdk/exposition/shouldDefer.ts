...
export function shouldDefer<TScope>(entries: readonly ToolEntry<TScope>[], contextWindow?: number) {
...
function estimateTokens<TScope>(entries: readonly ToolEntry<TScope>[]): number {
  let characters = 0;
