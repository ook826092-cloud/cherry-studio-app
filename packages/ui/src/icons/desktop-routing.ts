...
export const MODEL_ICON_PATTERNS: ReadonlyArray<readonly [RegExp, string]> = [
...
export const MODEL_TO_PROVIDER_ICON_PATTERNS: ReadonlyArray<readonly [RegExp, string]> = [
